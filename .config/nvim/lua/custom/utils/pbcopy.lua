...
-- todo: refactor later move this to its own util file
local function get_visual_selection()
  return table.concat(M.get_visual_selection_text() or {}, "\n")
end

function M.copy_to_clipboard()
  vim.fn.system("printf '%s' " .. vim.fn.shellescape(get_visual_selection() or "" ) .. " | pbcopy")
end
